...
$settings['hash_salt'] = 'UPHKbQdcVKSAjgVRHCjlfcekCDDwIqWyyfyhQOtwMaaxBYdDPAQlOExXHOrFijBY';
...
$config['language.negotiation']['url']['domains']['en'] = 'greenplants.ddev.site';
$config['language.negotiation']['url']['domains']['es'] = 'plantasgreen.ddev.site';
